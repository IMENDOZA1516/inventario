...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:Mendoza0101@localhost:5432/inventario"
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SECRET_KEY'] = 'Mendoza0101'  # Necesario para Flask-Login
db.init_app(app)
